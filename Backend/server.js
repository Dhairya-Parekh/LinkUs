                      ...
                      .then(response4 => {
                        ...
                        query.get_added_members(req.query)
                          .then(response5 => {
                            ...
                            query.get_deleted_groups(req.query)
                              .then(response6 => {
                                all_updates["deleted_groups"] = response6;
                                query.get_new_groups(req.query)
                                  .then(async response7 => {
                                    all_updates["get_added"] = response7;
                                    for (let i = 0; i < all_updates["get_added"].length; i++) {
                                      ...
                                      await query.get_group_members(temp_body)
                                        .then(response8 => {
                                          all_updates["get_added"][i]["members"] = response8;
                                        })
                                    }
        ...
        if (response.success) {
          ...
          query.get_group_members(temp_body)
            .then(response1 => {
              ...
              delete_group_list = { delete_group_list: temp_list }
              query.delete_group_action(delete_group_list);
              query.delete_group(temp_body)
            })
        }
