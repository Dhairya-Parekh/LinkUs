...
class _GroupInfoPageState extends State<GroupInfoPage> {
  ...
  Future<void> _deleteGroup() async {
    ...
    await API
        ...
        .then((Map<String, dynamic> response) async {
      if (response["success"]) {
        await LocalDatabase.deleteGroup(groupID).then((value) {
  ...
  _showAddMembersPopUp() async {
    await showModalBottomSheet(
      ...
      builder: (context) {
        return AddMemberPopup(user: widget.user, group: widget.group);
      },
    );
    _loadGroupInfo();
  }
                  ...
                  Padding(
                    ...
                    child: Center(
                      child: userInfo["isAdmin"]
                          ? ElevatedButton(
                              onPressed: _showAddMembersPopUp,
